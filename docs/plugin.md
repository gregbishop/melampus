...
without Lightroom. Without the executable nothing is greyed, the engines'
names stand in for their titles, and the note is
...
- **47 rules tests** — never-overwrite for ratings, labels and flags; dry-run;
